...
export default function Navbar() {
    ...
    return (
        <div className="flex items-center justify-between  px-4 pt-1 pb-4 bg-white rounded-2xl  shadow-lg w-[600px] m-auto  sm:m-auto sm:mt-2 sm:p-2 sm:w-[95%] ">
            <motion.div 
            ...
            <div className="text-[28px] flex justify-center items-center text-slate-600 font-Nunito font-bold sm:">
                wisdom
            </div>
